...
if [ -n "15.086770013834853" ] && [ -n "10.738268512131722" ] && [ -n "7.471734253723671" ]; then
    python contextual_opt/src/cad/single_channel_inlet_outlet_cfd_export.py         15.086770013834853 10.738268512131722 7.471734253723671
else
